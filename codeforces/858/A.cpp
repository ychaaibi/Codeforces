...
/*   Updated: 2022/12/03 14:10:56 by ychaaibi         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void    solve()
{
    ...
    ll  temp = n;
    while (temp and temp % 2 == 0 and ++c_2) temp /= 2;
    
    temp = n;
    while (temp and temp % 5 == 0 and ++c_5) temp /= 5;
    ...
    while (c_2 < k and c_2 < c_5 and ++c_2) mult *= 2;
    while (c_5 < k and c_5 < c_2 and ++c_5) mult *= 5;
    while (c_2 < k and ++c_2) mult *= 10;
