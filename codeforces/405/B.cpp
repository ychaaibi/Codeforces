...
/*   Updated: 2022/12/05 11:53:44 by ychaaibi         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void    solve()
{
    ...
    while (p1 < s.length())
    {
        ...
        else if (s[p1] == 'L' or s[p1] == 'R')
        {
            if (s[p1] == 'R' and s[p_s] == 'L')
                ans += count;
            else if (s[p1] == 'L' and s[p_s] == 'R')
                ans += (p1 - p_s - 1) % 2;
            count = 0;
            p_s = p1;
        }
