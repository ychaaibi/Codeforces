...
void    solve()
{
    ...
    ll turn_needed = ( xb - xa - 1);

    // Alice have possible to win
    // cout << turn_needed << endl;
    if ( turn_needed % 2 == 0 )
    {
        ll bob_steps = turn_needed / 2, alice_steps = turn_needed / 2;
        ...
        {
            yb += min(w - yb, bob_steps );
            ya += min(w - ya, alice_steps );
        ...
        {
            yb -= min(yb - 1, bob_steps);
            ya -= min(ya - 1, alice_steps);
    ...
    {
        ll bob_steps = turn_needed / 2, alice_steps = turn_needed / 2 + 1;
