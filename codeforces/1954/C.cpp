...
struct node
{
    ...
    node(int mn_node, int mn_count, int mx_node, int mx_count )
    {
        this->mn_node = mn_node;
        this->mn_count = mn_count;
        this->mx_node = mx_node;
        this->mx_count = mx_count;
    };
};
...
struct comp {
    ...
    {
        if ( a.mn_count > b.mn_count )
            return ( true );
        else if ( a.mn_count < b.mn_count )
            return ( false );
        return ( a.mx_count >= b.mx_count );
        return ( false );
    };
};
